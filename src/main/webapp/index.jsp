...
<body>
    <div class="container">
        <div class="content">
            ...
            <p>My name is <span class="highlighted-name">Jayashree</span>, I am an <span class="trainer">AWS and DevOps Trainer</span>.</p>
            <p class="curriculum"><em>My Recommended curriculum to become a DevOps Engineer:</em></p>
            <p><strong>AWS Concepts:</strong> Introduction to Cloud, Cloud Service Providers, AWS Global Infrastructure,EC2 S3, EFS, EC2, Auto Scaling, Load Balancers, VPC, IAM, RDS, Dynamo DB, SNS, Cloud Watch, LighSail, Cloud Trial, SQS, SES, Route 53, SnowBall, Elastic BeanStalk, Cloud Formation</p>
